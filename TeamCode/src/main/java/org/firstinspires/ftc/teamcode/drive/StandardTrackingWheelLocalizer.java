...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.598; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -9.71; // in; offset of the lateral wheel
